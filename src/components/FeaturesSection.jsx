...
export default function FeaturesSection() {
  ...
  return (
    <section className="relative w-full bg-[#050505] text-white py-32 px-6 flex flex-col items-center overflow-hidden font-[family-name:var(--font-geist)]">
      ...
      <motion.div 
        ...
        className="max-w-[800px] text-center mb-24 relative z-10"
      >
        <h2 className="text-[16px] uppercase tracking-[0.2em] text-blue-400 font-bold mb-6">Invisible Threats, Visible Data</h2>
        <h3 className="text-[54px] leading-[1.1] font-semibold tracking-[-0.02em] text-gray-100">
          Gain total awareness of the <br /> environment you create.
        </h3>
      </motion.div>

      {/* Grid of Features */}
      <div className="w-full max-w-[1400px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
        ...
        <motion.div 
          ...
          className="group relative flex flex-col justify-between p-10 rounded-[2rem] bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.05] transition-colors"
        >
          <div>
            ...
            <h4 className="text-[28px] font-semibold mb-4 text-gray-100">Live Telemetry</h4>
            <p className="text-[18px] text-gray-400 leading-relaxed font-light">
        ...
        >
          <div>
            ...
            <h4 className="text-[28px] font-semibold mb-4 text-gray-100">Cross-Room Audits</h4>
            <p className="text-[18px] text-gray-400 leading-relaxed font-light">
        ...
        <motion.div 
          ...
          className="group relative flex flex-col justify-between p-10 rounded-[2rem] bg-gradient-to-br from-white/[0.08] to-white/[0.01] border border-blue-500/30 hover:shadow-[0_0_40px_0_rgba(59,130,246,0.15)] transition-all"
        >
          <div>
            ...
            <h4 className="text-[28px] font-semibold mb-4 text-white">LSTM AI Forecasting</h4>
            <p className="text-[18px] text-gray-300 leading-relaxed font-light">
